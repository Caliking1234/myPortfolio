...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-10 md:py-10 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white tracking-wider">
        Piyush Sharma <br /> multi-disciplinay developer
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        I create stunning products using cutting-edge technologies and
        frameworks. As a passionate freelancer, I thrive on crafting exceptional
        solutions and delivering outstanding results for my clients.
      </p>
    </div>
  );
};
